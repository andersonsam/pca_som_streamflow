function [N,nx,ny] = get_numberOfPatterns(data)

% NOTE: Based off of scipts by Valentina Radic.  
%
% Syntax: [N,nx,ny] = get_numberOfPatterns(data)
%
% This function determines the optimal number of patterns (ie: number of
% nodes to use in SOM).  This function uses heirarchical clustering method.
%
